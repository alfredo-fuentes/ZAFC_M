...
define view entity ZI_BOOKING_AFC_M
  as select from zbooking_afc_m
  association to parent ZI_TRAVEL_AFC_M as _Travel
  on $projection.TravelId = _Travel.TravelId
  composition [0..*] of ZI_BOOKINGSUPPL_AFC_M as _BookingSuppl  
